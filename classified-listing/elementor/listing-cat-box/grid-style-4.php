...
<div class="rtcl rtcl-categories-elementor rtcl-categories rtcl-categories-grid rt-el-listing-cat-box-1 rt-el-listing-cat-box-4 <?php echo esc_attr( $settings['rtcl_cat_box_alignment']
    ...
    <div class="rtcl-row rtcl-no-margin">
		...
		foreach ( $terms as $trm ) {
			...
			echo '<div class="rt-glow-wrapper">';
			echo '<div class="rt-glow"></div>';
			echo '<div class="rt-glow" style="--rt-glow-start:2.5s"></div>';
