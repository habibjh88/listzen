...
?>
<div class="rtcl-el-pricing-box rtcl-el-pricing-box-view-4 rtcl-el-pricing-box-<?php echo esc_html( $style ); ?> content-alignment-<?php echo esc_html( $content_alignment ); ?>">
	<?php if ( $pricing_label ) { ?>
        <span class="pricing-badge"><?php echo esc_html( $pricing_label ); ?></span>
	<?php } ?>
