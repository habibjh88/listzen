...
while ( $the_loops->have_posts() ) :
    ...
    <div <?php Functions::listing_class( [ 'rtcl-widget-listing-item', 'listing-item swiper-slide-customize', 'rtcl-listing-card', 'style-category-thumb', $img_position_class ] ); ?>>
        <?php
        ...
        if ( $phone && $instance['rtcl_show_phone'] ) :
            ...
            <div class="rtin-phn rtin-el-button">
                <a class="rtcl-phone-reveal not-revealed" href="tel:<?php echo esc_attr( $phone ); ?>" data-phone="<?php echo esc_attr( $phone ); ?>"><i
                            ...
                            aria-hidden="true"></i><span><?php esc_html_e( 'Show Phone No', 'listzen' ); ?></span></a>
            </div>
        <?php endif; ?>
