...
class AlfaColorControl extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'listzen-custom-controls-css', listzen_get_assets('customize/css/customizer.css'), [ 'wp-color-picker' ], '1.0', 'all' );
		wp_enqueue_script(
			'listzen-custom-controls-js',
			listzen_get_assets('customize/js/customizer.js'),
