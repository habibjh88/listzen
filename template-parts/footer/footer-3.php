...
$listzen_copyright_center = listzen_option( 'listzen_contact_footer' ) ? 'justify-content-between' : 'justify-content-center';
?>
	...
	<div class="footer-top-wrapper">
		<div class="footer-container <?php echo esc_attr( $listzen_footer_width ) ?>">
			<div class="tooter-top-inner">
				...
				<div class="promo-text-wrap d-flex align-items-center <?php echo esc_attr( $listzen_copyright_center ); ?>">
					<?php if ( listzen_option( 'listzen_contact_footer' ) ) { ?>
						<div class="footer-promo-title"><?php listzen_html( listzen_option( 'listzen_ready_label' ), false ); ?></div>
						<div class="listzen-button">
							<a href="<?php echo esc_url( listzen_option( 'listzen_contact_button_url' ) ) ?>"
							   class="btn button-2">
								<?php listzen_html( listzen_option( 'listzen_contact_button_text' ), false ); ?>
				...
				<div class="listzen-footer-star-shape">
...
<?php if ( is_active_sidebar( 'listzen-footer-sidebar' ) ) : ?>
	<div class="footer-widgets-wrapper">
		...
		<div class="listzen-footer-shape">
